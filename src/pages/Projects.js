...
function Projects() {
  ...
  const handleFlip=(props)=>{
    document.getElementById(props).classList.add("projects_flip","projects_flipShadow")
    document.getElementById(props).classList.remove("projects_frontContainer")
  }
  
  const handleFlipBack=(props)=>{
    document.getElementById(props).classList.remove("projects_flip","projects_flipShadow")
  }
                ...
                <div className='projects_innercontainer2'>
                  ...
                  <ul className='projects_linkContainer'>
                    ...
                    <li className='projects_link'>
                      <button className='projects_button' onClick={()=>handleFlip("flip"+project.id)}>
                        READ MORE
                      </button>
                    </li>
                  </ul>
          ...
          <div className='projects_backContainer' id={`flip${project.id}`}>
            ...
            <ul className='projects_listContainer'>
              {project.tech.map(items => (
                <li className='projects_list' key={items}><i>{items}</i></li>
              ))}
            </ul>
            <ul className='projects_linkContainer'>
              <li className='projects_link'>
                <button className='projects_button' onClick={()=>handleFlipBack("flip"+project.id)}>
                  READ LESS
                </button>
              </li>
            </ul>
